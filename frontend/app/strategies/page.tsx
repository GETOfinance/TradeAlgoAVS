...
export default function StrategiesPage() {
  // Using mock strategies for now, update implementation might come later
  ...
  }, [isConnected, address, getUserSubscriptions, getActiveSubscribersCount, getTotalSubscribersCount, strategies]);
