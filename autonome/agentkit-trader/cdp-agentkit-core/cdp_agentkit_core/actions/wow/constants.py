...
WOW_FACTORY_CONTRACT_ADDRESSES = {
    "sonic-blaze-testnet": "0x04870e22fa217Cb16aa00501D7D5253B8838C1eA",
    "sonic": "0x997020E5F59cCB79C74D527Be492Cc610CB9fA2B",
}
...
def get_factory_address(network: str) -> str:
    ...
    Args:
        network (str): The network ID to get the contract address for.
            Valid networks are: sonic-blaze-testnet, sonic.
